...
public class Connection {
    ...
    public Connection(String latitude, String longitude, String year, String month, String day) {
        composedUrl = BASE_URL + "?lat=" + latitude + "&lng=" + longitude+"&date="+year+"-"+month+"-"+day;
    }
